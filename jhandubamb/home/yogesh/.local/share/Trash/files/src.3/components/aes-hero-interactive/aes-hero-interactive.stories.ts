...
export default {
  ...
  argTypes: {
    defaultSlot: {
      name: 'Default Slot',
      description:
        'The default slot. Anything placed in this slot becomes the slides in the slideshow, though using a Hero Slide is recommended.',
    },
    el: {
      table: {
        disable: true,
  ...
  args: {
    ...
    bgVideo:
      'https://player.vimeo.com/progressive_redirect/playback/724873019/rendition/1080p/file.mp4?loc=external&signature=8bda55b5e7a9df148ecb4c3a4ec1939729443dd271ae3cd4504de29ddbb15a38',
  },
}

const Template = ({ bgVideo, duration, progress }) =>
  html`
