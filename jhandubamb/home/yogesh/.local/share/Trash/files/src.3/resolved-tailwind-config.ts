...
export default {
  ...
  backgroundImage: {
    ...
    "rainbow-gradient-x":
      "linear-gradient(to right, rgb(50, 80, 252), rgb(158, 112, 255), rgb(42, 206, 235), rgb(44, 191, 56))",
    "rainbow-gradient-y":
      "linear-gradient(to bottom, rgb(50, 80, 252), rgb(158, 112, 255), rgb(42, 206, 235), rgb(44, 191, 56))",
  },
  gradientColorStops: {
    neutrals: {
      white: "rgb(255, 255, 255)",
