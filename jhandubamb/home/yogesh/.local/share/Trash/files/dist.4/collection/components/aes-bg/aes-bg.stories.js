...
export default {
  ...
  argTypes: Object.assign(Object.assign({}, argTypeSlotContent), { verticalPadding: Object.assign(Object.assign({}, argTypeSize), { name: 'Vertical Padding Size' }) }),
};
export const BackgroundColor = ({ verticalPadding }) => html `
...
export const BackgroundImageTopRight = ({ verticalPadding }) => html `
    <aes-section vertical-padding="${ifDefined(verticalPadding)}">
      <aes-container>
...
export const BackgroundImageBottom = ({ verticalPadding }) => html `
    <aes-section vertical-padding="${ifDefined(verticalPadding)}">
