...
const AESCta = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "heading-image-container" }, index.h("slot", { name: "header" }), index.h("slot", { name: "multimedia" })), index.h("aes-line", null), this.linkData && (index.h("aes-link", { href: this.linkData.url, target: this.linkData.target }, `${this.linkData.text}${this.displayLinkArrow ? ' \u2192' : ''}`))));
  }
  static get watchers() { return {
    "link": ["parseLinkData"]
  }; }
};
AESCta.style = aesCtaCss;

exports.aes_cta = AESCta;
