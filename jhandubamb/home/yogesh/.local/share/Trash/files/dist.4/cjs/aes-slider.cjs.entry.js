...
const AesSlider = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "slides-wrapper" }, index.h("slot", { name: "slides" }), this.displayArrows && (index.h("button", { class: "slides-button slides-previous", onClick: this.prevSlide, type: "button" }, index.h("aes-icon", { icon: enums.IconType.CHEVRON_LEFT }))), this.displayArrows && (index.h("button", { class: "slides-button slides-next", onClick: this.nextSlide, type: "button" }, index.h("aes-icon", { icon: enums.IconType.CHEVRON_RIGHT })))), this.displayDots && (index.h("div", { class: "slides-dots", ref: el => (this.dotsContainer = el) }))));
  }
  get el() { return index.getElement(this); }
};
AesSlider.style = aesSliderCss;

exports.aes_slider = AesSlider;
