...
const AesTextInput = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("label", { htmlFor: this.fieldName, class: { hide: this.hideLabel } }, this.labelText), index.h("input", Object.assign({ type: this.fieldType, name: this.fieldName, disabled: this.disabled, required: this.required, placeholder: this.hideLabel ? this.labelText : '' }, this.inputOptions))));
  }
};
AesTextInput.style = aesTextInputCss;

exports.aes_text_input = AesTextInput;
