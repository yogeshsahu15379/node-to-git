...
export default {
  ...
  argTypes: {
    logoVersion: Object.assign({}, argTypeLogo),
    logoUrl: {
      control: {
        type: 'text',
      },
...
export const SiteHeader = ({ logoVersion, logoUrl, languageselector }) => {
  return html `
    <aes-site-header>
      ...
      <aes-language-selector slot="language-selector" languageselector=${JSON.stringify(languageselector)} >
