...
export default {
  ...
  argTypes: Object.assign(Object.assign(Object.assign({}, argTypeSlotContent), argTypeTarget), { disabled: {
      control: {
        type: 'boolean',
      },
    }, shouldDisplayArrow: {
...
const Template = ({ defaultSlot, disabled, shouldDisplayArrow, url, target, variant, }) => html `
    <aes-button
      url="${ifDefined(url)}"
