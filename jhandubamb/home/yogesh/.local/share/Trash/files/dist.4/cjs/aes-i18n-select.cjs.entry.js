...
const AesI18nSelect = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("label", { class: "hidden" }, "option"), index.h("select", { name: "option", onChange: this.redirectUser, disabled: this.disabled }, this.optionList.map(v => (index.h("option", { value: v.url, selected: v.url === this.value }, v.value)))), index.h("aes-icon", { icon: enums.IconType.I18N_WHITE, class: "white" }), index.h("aes-icon", { icon: enums.IconType.I18N_GRAY, class: "gray" })));
  }
};
AesI18nSelect.style = aesI18nSelectCss;

exports.aes_i18n_select = AesI18nSelect;
