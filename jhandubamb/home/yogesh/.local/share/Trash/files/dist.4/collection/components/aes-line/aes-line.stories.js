...
export default {
  ...
  argTypes: {
    animDuration: {
      ...
      control: {
        type: 'text',
        description: 'The time the animation lasts in CSS time units: https://developer.mozilla.org/en-US/docs/Web/CSS/time',
      },
    },
...
export const Line = ({ animDuration, animThreshold, direction, displayAnimated, }) => html ` <aes-line
