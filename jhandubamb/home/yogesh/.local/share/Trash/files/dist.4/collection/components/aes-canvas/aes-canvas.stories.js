...
import { argTypeColor, argTypeHidden, argTypeImageUrl, argTypeNeutralColor, argTypeSpacing, } from '../../utils/utils';
...
export default {
  ...
  argTypes: {
    ...
    bgColor: Object.assign(Object.assign({}, argTypeNeutralColor), { name: 'Background Color' }),
    bgHoverImage: {
    ...
    borderColor: Object.assign(Object.assign({}, argTypeColor), { name: 'Border Color' }),
    displayDropShadow: {
    ...
    outerPaddingTop: Object.assign(Object.assign({}, argTypeSpacing), { name: 'Outer Wrapper Top Padding' }),
    outerPaddingBottom: Object.assign(Object.assign({}, argTypeSpacing), { name: 'Outer Wrapper Bottom Padding' }),
    outerPaddingLeft: Object.assign(Object.assign({}, argTypeSpacing), { name: 'Outer Wrapper Left Padding' }),
    outerPaddingRight: Object.assign(Object.assign({}, argTypeSpacing), { name: 'Outer Wrapper Right Padding' }),
    paddingTop: Object.assign(Object.assign({}, argTypeSpacing), { name: 'Body Top Padding' }),
    paddingBottom: Object.assign(Object.assign({}, argTypeSpacing), { name: 'Body Bottom Padding' }),
    paddingLeft: Object.assign(Object.assign({}, argTypeSpacing), { name: 'Body Left Padding' }),
    paddingRight: Object.assign(Object.assign({}, argTypeSpacing), { name: 'Body Right Padding' }),
  },
  args: {
    outerPaddingTop: '8',
...
const Template = ({ bgColor, bgHoverImage, bgVimeoVideo, isAutoplay, isControls, borderColor, bodyContent, cta, image, outerPaddingTop, outerPaddingBottom, outerPaddingLeft, outerPaddingRight, paddingTop, paddingBottom, paddingLeft, paddingRight, displayBorder, displayDropShadow, }) => html `
    <div class="flex">
      <aes-canvas
